	...
	<div class="nb-filter-http-selection" v-show="filter.visible">
		...
		<div class="title-area clearfix">
			<!--<span>-->
				...
				<!--</a>-->
			<!--</span>-->
			<button class="btn btn-default btn-sm ml15" style="color: rgb(153, 153, 153);" @click="show=!show">
				<span v-if="show">
				  {{activeItem.name ? activeItem.name : "请选择..."}}
           <i class="fa fa-angle-up ml10"></i>
        </span>
				<span v-else>
				  {{activeItem.name ? activeItem.name : "请选择..."}}
           <i class="fa fa-angle-down ml10"></i>
        </span>
			</button>
		</div>
		<NbExpanding>
			<div v-show="show">
				<div class="content-area">
					<div class="row">
						...
						<div class="col-xs-12">
							<div class="mb10 cursor br4 border" v-for="(item,index) in pager.getList()" :key="index"
