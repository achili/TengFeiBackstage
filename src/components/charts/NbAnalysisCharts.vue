<template>
  <div class="nb-analysis-charts">
    <div class="row mt10">
      <div class="col-md-12">
        <NbLoadingButton :entity="summaryAnalysis" @click="refresh" createText="生成图表" saveText="生成图表" createIcon="fa fa-check"  :callback="refresh"></NbLoadingButton>
      </div>
    </div>
...
<style lang="less">
  .nb-analysis-charts {
    ...
    .card {
      max-width: 400px;
      background-color: rgba(244, 163, 34, 0.55);
      margin: 10px 0;
      cursor: pointer;
      ...
      &.blue {
        background-color: rgba(0, 120, 193, 0.82);
        .title {
