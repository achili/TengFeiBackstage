...
export default class Filter {
  ...
  constructor (type, name, key, options, Clazz, word, visible = true, component) {
    if (!type || !name || !key) {
    ...
    } else if( type === Type.SPACE_SELECTION){

    }else if( type === Type.SPACE_MULTI_SELECTION){
  ...
  putValue (value) {
    ...
    } else if(this.type === Type.SPACE_MULTI_SELECTION){
      let draftArray = null;
      if (value instanceof Array) {
        draftArray = value
      } else {
