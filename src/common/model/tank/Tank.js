...
export default class Tank extends BaseEntity {
  constructor(filter = '*', privacy = false, maxSize = 50 * 1024 * 1024 * 1024, uploadHint = null) {
    super();
  ...
  getUrlBySize(h,w){
    return this.url + '?imageProcess=resize&imageResizeM=fill&imageResizeH=' + h + '&imageResizeW=' + w;
  }
