<template>
  <div>
    ...
    <select class="user-selections form-control" multiple="multiple">
    </select>
...
<script>
  ...
  import $ from "jquery";
  import "select2";
  import "../../common/fork/select2/zh-CN";
  ...
  export default{
    ...
    mounted(){
      ...
      let that = this;
      let authorization = this.$http.headers.common['Authorization'];
        ...
        ajax: {
          ...
          processResults: function (data, params) {
            ...
            return {
              ...
              pagination: {
                more: (params.page + 1) * pageSize < data.data.totalItems
              }
            };
          },
          cache: true
