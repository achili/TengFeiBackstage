<template>
  ...
  <div class="border-radius-5 border p5">
    ...
    <div class="mt10 mb10" v-for="(attribute,index) in attributeList" :key="index" v-if="!attribute.isPrimitive && attribute.packageName !== 'java.util.List'">
...
<script>
  ...
  import NbCheckbox from "../../../../../components/NbSummaryCheckbox";
  import AttributeCheckboxChildren from "./AttributeCheckboxChildren.vue";
