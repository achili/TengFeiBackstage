  ...
  <div class="animated fadeIn news-list">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="pull-right">
          <span class="pull-right">
            <button style="width: 128px;height: 37px;" class="btn btn-theme" @click.stop.prevent="$router.push('/by/summary/create')">
               <span>创建汇总统计</span>
            </button>
          </span>
    ...
    <div class="row mt10">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12 mt10" align="center">
        <div v-for="(summary,index) in pager.data"  style="height: 100px;font-size: 16px;color: #666666;line-height: 100px;" class="bg-white mt10 cursor" :key="summary.uuid" :class="summary.deleted === true ? 'bg-change':''"
             @click.stop.prevent="summary.deleted||$router.push({path:'/by/summary/edit',query:{uuid:summary.uuid}})" >
          <div class="media" >
            <div class="pull-left" style="padding-left: 40px;" >{{index + 1}}.{{summary.name}}</div>
            <div class="pull-right" style="padding-right: 40px;"  >
              <a title="删除" href="javascript:void(0)" @click.stop.prevent="summary.confirmDel(refresh)">
